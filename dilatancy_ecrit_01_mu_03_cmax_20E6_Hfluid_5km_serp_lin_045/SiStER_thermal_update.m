...
if isfield(MAT,'cp')==0 || isfield(MAT,'k')==0   
    ...
    [km, cpm]=SiStER_get_thermal_properties(im,MAT,PARAMS,Tm,xm,xsize,topo_x,topo_y,ym);
...
% THERMAL SOLVE
[T]=SiStER_thermal_solver_sparse_CFD(x,y,Told,rhofield,cpfield,kfield,dt_m,BCtherm,zeros(size(T)),BCM);
