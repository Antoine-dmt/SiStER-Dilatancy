...
PARAMS.center_depth = 10e3 ; %implanting fault point where it crosses simulation center
PARAMS.band_width = 1e3; % Weakness band width simulating fault
...
BC.right=[1 0 3.1688e-10];%1 cm/yr for each here
