...
sxym=sxym(Iin);
epsIIm=epsIIm(Iin);
xim = xim(Iin); % serpentinization
fcm = fcm(Iin);%fluid circulation
...
% passed to nodes. 
[xm, ym, im, Ifix, mp, ep, idm, Tm, sxxm, sxym, epNH, epsIIm,xim,fcm]=SiStER_patch_marker_holes(icn,jcn,quad,Nx,Ny,Mquad,Mquad_crit,xm,ym,x,y,dx,dy,im,ep,idm,Tm,sxxm,sxym,epNH, epsIIm,xim,fcm);    
